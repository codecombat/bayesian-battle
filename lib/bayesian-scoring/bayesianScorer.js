...
var BayesianScorer, _;

_ = require('lodash');

BayesianScorer = (function() {
  function BayesianScorer(scoreUncertainty, k, scoreStandardDeviationCoefficient) {
  ...
  */
  ...
  BayesianScorer.prototype.updatePlayerSkills = function(playerAndScoreObjectsArray) {
  ...
  BayesianScorer.prototype.calculatePlayerScoreFromPlayerMetrics = function(playerMeanStrength, playerStandardDeviation) {
    return playerMeanStrength - this.scoreStandardDeviationCoefficient * playerStandardDeviation;
  };

  BayesianScorer.prototype.validateInputArray = function(playerAndScoreObjectsArray) {
  ...
  BayesianScorer.prototype.validateRequiredProperties = function(playerAndScoreObject) {
  ...
  BayesianScorer.prototype.validateUniquePlayerIDs = function(playerAndScoreObjectsArray) {
    var ids, uniqueIDs;
  ...
  BayesianScorer.prototype.validatePlayerArrayLength = function(playerAndScoreObjectsArray) {
    if (playerAndScoreObjectsArray.length <= 1) {
      throw new Error("Input array must contain two objects or more");
    }
  };

  BayesianScorer.prototype.validatePlayerObjectValues = function(playerAndScoreObject, arrayLength) {
  ...
  BayesianScorer.prototype.calculateTotalPerformanceUncertainty = function(playerOneStandardDeviation, playerTwoStandardDeviation) {
  ...
  BayesianScorer.prototype.calculateChanceOfPlayerOneBeatingPlayerTwo = function(playerOneMeanStrength, playerTwoMeanStrength, performanceUncertainty) {
    return this.calculateMatchSuccessProbability(playerOneMeanStrength, playerTwoMeanStrength, performanceUncertainty);
  };

  BayesianScorer.prototype.calculateChanceOfPlayerTwoBeatingPlayerOne = function(playerTwoMeanStrength, playerOneMeanStrength, performanceUncertainty) {
    return this.calculateMatchSuccessProbability(playerTwoMeanStrength, playerOneMeanStrength, performanceUncertainty);
  };

  BayesianScorer.prototype.calculateMatchSuccessProbability = function(playerOneMeanStrength, playerTwoMeanStrength, performanceUncertainty) {
  ...
  BayesianScorer.prototype.calculateMeanStrengthChangePartial = function(playerOneStandardDeviation, performanceUncertainty, gameOutcomeValue, probabilityOfOneBeatingTwo) {
  ...
  BayesianScorer.prototype.calculateSquaredStandardDeviationChangePartial = function(playerOneStandardDeviation, performanceUncertainty, probabilityOfOneBeatingTwo, probabilityOfTwoBeatingOne) {
  ...
  BayesianScorer.prototype.calculatePairwiseGameOutcomeValue = function(playerOneGameRanking, playerTwoGameRanking) {
  ...
  BayesianScorer.prototype.sumArray = function(inputArray) {
    return inputArray.reduce(function(elementOne, elementTwo) {
      return elementOne + elementTwo;
    });
  };

  BayesianScorer.prototype.updateSkills = function(player, meanStrengthChangePartialSum, squaredStandardDeviationPartialSum) {
